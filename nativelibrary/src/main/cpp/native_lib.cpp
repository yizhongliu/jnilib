...
Java_com_iview_nativelibrary_MotoriControl_nativeSwitchProjector(
        JNIEnv *env,
...
extern "C" JNIEXPORT void
Java_com_iview_nativelibrary_MotorControl_nativeSetKeyStone(
        JNIEnv *env,
...
extern "C" JNIEXPORT void
Java_com_iview_nativelibrary_MotorControl_nativeResetEncoder(
        JNIEnv *env,
...
Java_com_iview_nativelibrary_MotorControl_nativeGetEncoderCount(
        JNIEnv *env,
        jobject /* this */,jint encoderNum, jint dir) {
