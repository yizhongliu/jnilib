...
Java_com_iview_dance_MotorControl_nativeControlMotor(
        JNIEnv *env,
...
extern "C" JNIEXPORT jint
Java_com_iview_dance_MotorControl_nativeSetMotorSpeed(
        JNIEnv *env,
...
extern "C" JNIEXPORT jint
Java_com_iview_dance_MotorControl_nativeSetMotorDirection(
        JNIEnv *env,
...
extern "C" JNIEXPORT jint
Java_com_iview_dance_MotorControl_nativeStartMotorRunning(
        JNIEnv *env,
...
extern "C" JNIEXPORT jint
Java_com_iview_dance_MotorControl_nativeStopMotorRunning(
        JNIEnv *env,
...
Java_com_iview_dance_MotorControl_nativeGetMotorEnable(
        JNIEnv *env,
        jobject /* this */,jint motorId) {
...
Java_com_iview_dance_MotorControl_nativeControlMultiMotors(
        JNIEnv *env,
...
extern "C" JNIEXPORT void
Java_com_iview_dance_MotorControl_nativeStopMultiMotors(
        JNIEnv *env,
        jobject /* this */) {
